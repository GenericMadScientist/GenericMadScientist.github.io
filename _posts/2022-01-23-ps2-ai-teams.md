...
This is an absolute mess and the main reason the order of your team can
technically matter. The intent was clearly to do the same as the above but with
a bunch of weights for lowering stats. However, whoever coded that function
